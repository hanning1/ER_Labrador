					...
					<div className="user-detail-content common-component-content">
						...
						>
							...
							<Descriptions.Item label="Full Name">
								{this.state.currRow.Name}
							</Descriptions.Item>
							<Descriptions.Item label="Email">
								{this.state.currRow.Email}
							</Descriptions.Item>
							<Descriptions.Item label="Eratos User ID">
								{this.state.currRow.EratosUserID}
							</Descriptions.Item>
							<Descriptions.Item label="Auth0 ID">
								{this.state.currRow.Auth0ID}
							</Descriptions.Item>
							<Descriptions.Item label="Administrator">
								{this.state.currRow.isAdmin}
							</Descriptions.Item>
							<Descriptions.Item label="Date and Time of User Created">
								{this.state.currRow.CreatedAt}
							</Descriptions.Item>
							<Descriptions.Item label="Info">
								{this.state.currRow.Info}
							</Descriptions.Item>
						</Descriptions>
					</div>
				</NavBar>
